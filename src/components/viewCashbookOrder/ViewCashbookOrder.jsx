...
function ViewCashbookOrder({ openViewModal, setOpenViewModal, recordId }) {
  ...
  const getOrder = async () => {
    try {
      const response = await axios.get(`${api_url}/api/v1/orders/${recordId}`, {
        headers: {
...
export default ViewCashbookOrder;
